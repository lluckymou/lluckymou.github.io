![lluc.dev](/assets/banner.png)

A personal site that is also a small world.

It's built so that **a casual visitor finds it pretty and leaves** - but a **curious** and **attentive**
...
sea. It's one 'simulation' (as opposed to a decoration), and the whole
...
any static server) to run.

---

## The idea: every visit is different

Open the home page and you land **at your own local time**, arriving there from 12 hours earlier in a short linear glide
...
## The home page (`index.html`) - the interactive living sky
...
### Eight themes, chosen by the sky in index.html
| sky | theme |
|---|---|
...
*Look closely. There's always more than there seems* ;)
